...
> [dotPlotly visualization](https://github.com/tpoorten/dotPlotly)

![*O. sativa* flye assembly aligned to nipponbare IRGSP-1.0 genome - dotPlotly overview](Images/nucmerAlign_showCoords_dotPlotly_out_7inches.png)
...
#### *O. sativa* flye genome assembly comparison fast versus hac basecaller config

![*O. sativa* query statistics of Mummer mapping to nipponbare reference](Tables/osat_flyes_mummerComp_fast_hac_reportSummary.png){width=60%}

<br><br>

![*O. sativa* dotPlotly alignment to nipponbare reference](Images/dotPlotly_fastVShac_comparison.jpg)
...
### RepeatExplorer - comparative analysis

> 300000 read pairs per plant
> 221bp read length for all reads

#### Comparative analysis summary

![RE - comparative analysis summary](Images/RE_compAnalysis/comparative_summary.png)

<br>

#### Proportion of annotated repeats

![Repeat proportion](Images/RE_compAnalysis/repeat_proportion_compAnal_overview.png)
...
![PCA analysis - all of 268 superclusters](Images/RE_compAnalysis/forPCA.tsv_factorExtra_biplot_PCAplot_v1.png)


![no plastids](Images/RE_compAnalysis/noPlastids_factorExtra_biplot_PCAplot_v1.png)


![Plastids](Images/RE_compAnalysis/plastid_factorExtra_biplot_PCAplot_v1.png)


![All](Images/RE_compAnalysis/All_factorExtra_biplot_PCAplot_v1.png)


![Angela](Images/RE_compAnalysis/Angela_factorExtra_biplot_PCAplot_v1.png)


![Athila](Images/RE_compAnalysis/Athila_factorExtra_biplot_PCAplot_v1.png)

![SIRE](Images/RE_compAnalysis/SIRE_factorExtra_biplot_PCAplot_v1.png)


![Tekay](Images/RE_compAnalysis/Tekay_factorExtra_biplot_PCAplot_v1.png)


![rDNA](Images/RE_compAnalysis/rDNA_factorExtra_biplot_PCAplot_v1.png)
